...
@interface ProvinceAreaCell() {
    ThreeSubView *_threeSubView;
}

@end

@implementation ProvinceAreaCell
...
- (void)_setupViews {
    ThreeSubView *threeSubView = [[ThreeSubView alloc] initWithFrame:CGRectMake(20, 0, kScreenWidth-40, 45)
...
- (void)updateWithModel:(ProvinceArea *)model {
    [_threeSubView.leftButton setTitle:model.province forState:UIControlStateNormal];
