...
#ifndef ContactsExpand_Macro_h
#define ContactsExpand_Macro_h

#define kScreenWidth ([UIScreen mainScreen].bounds.size.width)

#define COLOR_CLEAR [UIColor clearColor]
#define COLOR_0096ff [UIColor colorWithRed:0x00 / 255.0f green:0x96 / 255.0f blue:0xff / 255.0f alpha:1.0f]
